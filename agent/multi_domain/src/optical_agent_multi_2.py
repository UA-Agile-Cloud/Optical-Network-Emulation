...
node_to_ports='/home/alan/bk_sep_29_2017/ArizonaEx/multi_domain/topology_discovery/node_to_ports'
ripple_function_file='/home/alan/bk_sep_29_2017/ArizonaEx/multi_domain/ryu_optical_agent/reversed_ripple_function_dB.txt'
...
# TO DO: Generate Python class ControlPlane for pure Control Plane functions (?).
    ...
    def controller_connections(self, switch):
        ...
        #controller_address = ("localhost", 6667)
        controller_address = ("10.129.36.202", 6667)
